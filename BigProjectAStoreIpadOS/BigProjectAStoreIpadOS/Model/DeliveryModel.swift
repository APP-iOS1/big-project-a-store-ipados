...
var sampleDeliveryData: [DeliveryModel] = [
    DeliveryModel(orderState: "0", orderNumber: "0046", productNumber: "p1", productName: "키보드", shippingDate: "발송 전", shipmentCompany: "대한통운", trackingNumber: "5264106429"),
    ...
    DeliveryModel(orderState: "0", orderNumber: "0044", productNumber: "p3", productName: "컴퓨터", shippingDate: "발송 전", shipmentCompany: "로젠택배", trackingNumber: "2460487362"),
    DeliveryModel(orderState: "0", orderNumber: "0043", productNumber: "p2", productName: "마우스", shippingDate: "발송 전", shipmentCompany: "한진택배", trackingNumber: "0583829596"),
    ...
    DeliveryModel(orderState: "0", orderNumber: "0040", productNumber: "p3", productName: "컴퓨터", shippingDate: "발송 전", shipmentCompany: "DHL", trackingNumber: "2079711029"),
    ...
    DeliveryModel(orderState: "0", orderNumber: "0038", productNumber: "p3", productName: "컴퓨터", shippingDate: "발송 전", shipmentCompany: "우체국 택배", trackingNumber: "0927592759"),
    ...
    DeliveryModel(orderState: "0", orderNumber: "0034", productNumber: "p3", productName: "컴퓨터", shippingDate: "발송 전", shipmentCompany: "롯데택배", trackingNumber: "1282498750"),
    ...
    DeliveryModel(orderState: "2", orderNumber: "0028", productNumber: "p8", productName: "노트북", shippingDate: "2022-12-16", shipmentCompany: "롯데택배", trackingNumber: "9217660420"),
    ...
    DeliveryModel(orderState: "2", orderNumber: "0025", productNumber: "p8", productName: "노트북", shippingDate: "2022-12-14", shipmentCompany: "우체국 택배", trackingNumber: "7490249528"),
    ...
    DeliveryModel(orderState: "2", orderNumber: "0022", productNumber: "p8", productName: "노트북", shippingDate: "2022-12-13", shipmentCompany: "대한통운", trackingNumber: "8075428609"),
    ...
    DeliveryModel(orderState: "2", orderNumber: "0019", productNumber: "p8", productName: "노트북", shippingDate: "2022-12-11", shipmentCompany: "FedEx", trackingNumber: "3987201129"),
    ...
    DeliveryModel(orderState: "2", orderNumber: "0015", productNumber: "p8", productName: "노트북", shippingDate: "2022-12-10", shipmentCompany: "대한통운", trackingNumber: "3029484736"),

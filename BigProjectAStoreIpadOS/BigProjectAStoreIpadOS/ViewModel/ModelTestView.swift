...
//				])
//
//				await model.createNewItem(with: "Test", item: ItemInfo(itemUid: UUID().uuidString, storeId: Auth.auth().currentUser?.uid ?? "test", itemName: "뇌물", itemCategory: "키보드", itemAmount: 5, itemAllOption: itemOption, itemImage: ["imagelink1", "imagelink2"], price: 2851000))
//

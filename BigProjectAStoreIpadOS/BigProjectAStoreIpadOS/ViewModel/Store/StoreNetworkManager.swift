	...
	public func requestItemInfo(with currentStoreUserUid: String?) async -> Void {
		...
		do {
			for id in currentStoreItemIdArray {
				...
				let requestedItem = ItemInfo(itemUid: itemUid, storeId: storeId, itemName: itemName, itemCategory: itemCategory,
//											 itemAmount: itemAmount,
											 itemAllOption: itemAllOptions, itemImage: itemImage, price: price)

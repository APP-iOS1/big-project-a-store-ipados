...
- <h4>이번 과정에서 겪은 새로운 경험들을 말해봅시다</h4>
  - 맡은 파트를 열심히 했지만 다른 부서와의 커뮤니케이션에 어려움이 많이 있었고 생각보다 개발에는 미리 정하고 가야하는 것들이 많다는 것 그리고 꼼꼼하게 더블체크까지 해야 한다는 점을 이번 단체프로젝트를 하며 알게 되었습니다.
- <h4>이 프로젝트를 참여하면서 무엇이 아쉬웠나요?</h4>
  - 너무나도 큰 규모였고 데이터흐름이 실제로 일어나는지 고객앱부터의 확인을 실제로 확인을 못해본점이 아쉽습니다. 또한 맡은파트만 알다보니 도와주고싶어도 사전지식이 부족해 도움을 주기 어려웠다는 점이 아쉽습니다.
